...
describe('Sort testing', () => {
  ...
  it('applies multi-column sorting by clicking headers and verifies row values', async () => {
    ...
    expect(numberAfterAscAsc).toEqual([testRows[0].number, testRows[1].number])
    ...
    expect(numberAfterAscDesc).toEqual([testRows[0].number, testRows[1].number])
    ...
    expect(numberAfterNoneAsc).toEqual([testRows[1].number, testRows[0].number])
  })
})
